    ...
    @isset($menus)
        <ul class="list-group">
            ...
            <li class="list-group-item list-group-item-action py-1 bg-warning position-relative menu">
                ...
                @isset($menu->subs)
                    <ul class="list-group position-absolute w-75 subs" style="z-index:99; display:none; left:100px; left:100px; top:0px">
                        @foreach ($menu->subs as $sub)
                            <li class="list-group-item list-group-item-action bg-success py-1">
...
<div class="main col-6">
    <marquee>{{ $ads }}</marquee>
@yield('center')    <!-- 替代區塊 main, news, login -->
</div>
...
<div class="text-center py-2 border-bottom my-1">主選單區</div>
<div class="up"></div>
@isset($images)     <!-- 引用Home.blade.php中index()的images -->
