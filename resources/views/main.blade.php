...
@section('center')
<div class="mivms" style="height:265px">
    @foreach ($mvims as $mv)
    ...
    <ul class="list-group" style="position:relative">
        @foreach ($news as $key => $new)
            <li class="list-group-item list-group-item-action p-1 new" style="position:unset">
                ...
                <div style="border:1px solid orange; box-shadow:1px 1px 5px #ccc; background:yellow; width:75%; 
                position:absolute; top:0; right:0; display:none; white-space:pre-wrap; 
